...
export default function Topbar({onLogout, onToggleMobile}){
  ...
  return <div className="topbar-inner">
    <div className="topbar-title"><button onClick={onToggleMobile} className="icon-button nav-trigger" aria-label="Open navigation"><List size={22}/></button><strong>{titles[location.pathname] || 'BlobeVM Manager'}</strong></div>
